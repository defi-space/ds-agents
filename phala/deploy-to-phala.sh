...
missing_vars=0
for var in AGENT1_PRIVATE_KEY AGENT1_ADDRESS AGENT1_API_KEY AGENT2_PRIVATE_KEY AGENT2_ADDRESS AGENT2_API_KEY AGENT3_PRIVATE_KEY AGENT3_ADDRESS AGENT3_API_KEY AGENT4_PRIVATE_KEY AGENT4_ADDRESS AGENT4_API_KEY STARKNET_RPC_URL INDEXER_URL GOOGLE_API_KEY MONGODB_ATLAS_URI; do
